<form class="well" method=POST>
    <fieldset>
        ...
        <div class="control-group "><label class="control-label" for="type">Тип</label><div class="controls"><select name="type" id="type">
            <option value="0">Все наименования</option>
            <option value="1">Только работы</option>
            <option value="2">Только запчасти</option>
        </select></div></div>
