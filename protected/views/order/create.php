...
$this->menu=array(
array('label'=>'Управление Заказ-наряды','url'=>array('admin')),
);
?>
...
<?php if($this->beginCache('1itemsAdd_'.$model->client->model_id.$model->withDiscount, array('duration'=>1))) { ?>
<?
$tabsArray = array(
    array(
        'label' => 'Двигатель',
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#addItemButton_edit').click(function() {
            items[currentItemId]['price'] = parseInt( $("#priceAddItems_edit").val() );
...
<br>
<div id="button_print" style="display:none">
    <?php $this->widget('bootstrap.widgets.TbButton', array(
        'type'=>'primary',
        'htmlOptions' => array(
